...
from components.layout import page_header, section_divider, page_footer, empty_state, success_message, error_message
...
def render():
    ...
    page_header("Tools", "Import, export, and maintenance utilities")
    ...
    page_footer("Stage 4 | Training Catalogue Manager")
